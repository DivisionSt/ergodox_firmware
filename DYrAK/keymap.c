...
#define DUAL_FUNC_12 LT(6, KC_F15)
#define DUAL_FUNC_13 LT(4, KC_4)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    LGUI(LCTL(KC_SPACE)),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_SHIFT,                                                                                                  KC_RIGHT_SHIFT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    TG(3),          DUAL_FUNC_0,    TO(8),          TG(4),
                                                                                                                    KC_AUDIO_VOL_UP,KC_TRANSPARENT,
                                                                                    LT(3, KC_BSPC), KC_TRANSPARENT, KC_AUDIO_VOL_DOWN,KC_TRANSPARENT, KC_ENTER,       LT(4, KC_SPACE)
  ),
