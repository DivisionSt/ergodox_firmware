...
#define DUAL_FUNC_9 LT(11, KC_F24)
#define DUAL_FUNC_10 LT(11, KC_0)
#define DUAL_FUNC_11 LT(3, KC_F23)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [6] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, LALT(LGUI(LCTL(LSFT(KC_1)))),LALT(LGUI(LCTL(LSFT(KC_2)))),LALT(LGUI(LCTL(LSFT(KC_3)))),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, LALT(LGUI(LCTL(LSFT(KC_6)))),LALT(LGUI(LCTL(LSFT(KC_7)))),KC_8,           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
