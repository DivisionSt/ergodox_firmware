...
#define DUAL_FUNC_16 LT(10, KC_F13)
#define DUAL_FUNC_17 LT(12, KC_E)
#define DUAL_FUNC_18 LT(9, KC_M)
#define DUAL_FUNC_19 LT(12, KC_7)
#define DUAL_FUNC_20 LT(7, KC_N)
#define DUAL_FUNC_21 LT(9, KC_F16)
#define DUAL_FUNC_22 LT(5, KC_N)
#define DUAL_FUNC_23 LT(13, KC_F8)
#define DUAL_FUNC_24 LT(13, KC_F14)
#define DUAL_FUNC_25 LT(5, KC_F9)
#define DUAL_FUNC_26 LT(15, KC_U)
#define DUAL_FUNC_27 LT(14, KC_J)
#define DUAL_FUNC_28 LT(2, KC_A)
#define DUAL_FUNC_29 LT(2, KC_S)
#define DUAL_FUNC_30 LT(4, KC_F15)
#define DUAL_FUNC_31 LT(6, KC_J)
#define DUAL_FUNC_32 LT(2, KC_R)
#define DUAL_FUNC_33 LT(9, KC_F23)
#define DUAL_FUNC_34 LT(4, KC_F12)
#define DUAL_FUNC_35 LT(5, KC_F3)
#define DUAL_FUNC_36 LT(4, KC_G)
#define DUAL_FUNC_37 LT(13, KC_F5)
#define DUAL_FUNC_38 LT(1, KC_F15)
#define DUAL_FUNC_39 LT(6, KC_L)
#define DUAL_FUNC_40 LT(10, KC_F4)
#define DUAL_FUNC_41 LT(1, KC_F5)
#define DUAL_FUNC_42 LT(4, KC_F5)
#define DUAL_FUNC_43 LT(6, KC_F7)
#define DUAL_FUNC_44 LT(11, KC_0)
#define DUAL_FUNC_45 LT(14, KC_F7)
#define DUAL_FUNC_46 LT(4, KC_F14)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TAB,         KC_TRANSPARENT, DUAL_FUNC_20,   KC_TRANSPARENT, DUAL_FUNC_21,   TD(DANCE_16),   DUAL_FUNC_22,                                   KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_33,   DUAL_FUNC_34,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_NO,          TD(DANCE_17),   LALT(KC_LEFT_SHIFT),TD(DANCE_18),   LGUI(LCTL(KC_F)),KC_NO,                                                                          TD(DANCE_19),   KC_NO,          LALT(LCTL(KC_ENTER)),TD(DANCE_20),   KC_NO,          KC_NO,
    KC_NO,          KC_NO,          KC_NO,          LALT(LCTL(KC_C)),KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                                                                                          TD(DANCE_21),   KC_NO,          LALT(LCTL(KC_ENTER)),TD(DANCE_22),   KC_NO,
  ...
  [3] = LAYOUT_ergodox_pretty(
    DUAL_FUNC_40,   ST_MACRO_0,     ST_MACRO_1,     ST_MACRO_2,     ST_MACRO_3,     ST_MACRO_4,     DUAL_FUNC_11,                                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_23),
  ...
  [5] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_24),                                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_20,   KC_TRANSPARENT, DUAL_FUNC_21,   TD(DANCE_25),   DUAL_FUNC_22,                                   KC_TRANSPARENT, DUAL_FUNC_46,   DUAL_FUNC_33,   DUAL_FUNC_34,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_LEFT_CTRL,   DUAL_FUNC_23,   DUAL_FUNC_24,   KC_TRANSPARENT, DUAL_FUNC_25,   KC_TRANSPARENT,                                                                 DUAL_FUNC_35,   KC_TRANSPARENT, DUAL_FUNC_36,   DUAL_FUNC_37,   KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, DUAL_FUNC_26,   DUAL_FUNC_27,   DUAL_FUNC_28,   DUAL_FUNC_29,   DUAL_FUNC_30,   KC_TRANSPARENT,                                 KC_TRANSPARENT, DUAL_FUNC_38,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
