...
#define DUAL_FUNC_13 LT(6, KC_4)
#define DUAL_FUNC_14 LT(3, KC_S)
#define DUAL_FUNC_15 LT(4, KC_F16)
#define DUAL_FUNC_16 LT(2, KC_F24)
#define DUAL_FUNC_17 LT(5, KC_Y)
#define DUAL_FUNC_18 LT(15, KC_L)
#define DUAL_FUNC_19 LT(15, KC_T)
#define DUAL_FUNC_20 LT(6, KC_Q)
#define DUAL_FUNC_21 LT(3, KC_1)
#define DUAL_FUNC_22 LT(9, KC_2)
#define DUAL_FUNC_23 LT(14, KC_L)
#define DUAL_FUNC_24 LT(13, KC_F18)
#define DUAL_FUNC_25 LT(1, KC_F18)
#define DUAL_FUNC_26 LT(9, KC_F11)
#define DUAL_FUNC_27 LT(4, KC_G)
#define DUAL_FUNC_28 LT(14, KC_0)
#define DUAL_FUNC_29 LT(2, KC_F18)
#define DUAL_FUNC_30 LT(11, KC_Q)
#define DUAL_FUNC_31 LT(11, KC_D)
#define DUAL_FUNC_32 LT(9, KC_C)
#define DUAL_FUNC_33 LT(9, KC_F20)
#define DUAL_FUNC_34 LT(14, KC_F14)
#define DUAL_FUNC_35 LT(4, KC_F14)
#define DUAL_FUNC_36 LT(6, KC_N)
#define DUAL_FUNC_37 LT(7, KC_F21)
#define DUAL_FUNC_38 LT(14, KC_5)
#define DUAL_FUNC_39 LT(4, KC_F23)
#define DUAL_FUNC_40 LT(14, KC_H)
#define DUAL_FUNC_41 LT(7, KC_I)
#define DUAL_FUNC_42 LT(5, KC_F8)
#define DUAL_FUNC_43 LT(9, KC_U)
#define DUAL_FUNC_44 LT(9, KC_F21)
#define DUAL_FUNC_45 LT(2, KC_I)
#define DUAL_FUNC_46 LT(15, KC_J)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      TD(DANCE_0),    TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    TD(DANCE_4),    TD(DANCE_5),                                    KC_TRANSPARENT, TD(DANCE_6),    TD(DANCE_7),    TD(DANCE_8),    TD(DANCE_9),    TD(DANCE_10),   TD(DANCE_11),
    ...
    LGUI(LCTL(KC_SPACE)),KC_LEFT_CTRL,   KC_TRANSPARENT, KC_LEFT_ALT,    KC_LEFT_GUI,                                                                                                    KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       DM_PLY1,
                                                                                                    DUAL_FUNC_13,   DUAL_FUNC_14,   TO(9),          TT(4),
                                                                                                                    KC_END,         KC_PAGE_UP,
                                                                                    KC_BSPC,        LT(2, KC_DELETE),KC_HOME,        KC_PGDN,        LT(3, KC_ENTER),KC_SPACE
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_13),                                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TAB,         KC_TRANSPARENT, DUAL_FUNC_21,   KC_TRANSPARENT, DUAL_FUNC_22,   TD(DANCE_14),   DUAL_FUNC_3,                                    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_33,   DUAL_FUNC_34,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_LEFT_CTRL,   DUAL_FUNC_23,   DUAL_FUNC_24,   KC_TRANSPARENT, DUAL_FUNC_25,   KC_TRANSPARENT,                                                                 DUAL_FUNC_35,   KC_TRANSPARENT, DUAL_FUNC_36,   DUAL_FUNC_37,   KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, DUAL_FUNC_26,   DUAL_FUNC_27,   DUAL_FUNC_28,   DUAL_FUNC_29,   DUAL_FUNC_30,   KC_TRANSPARENT,                                 KC_TRANSPARENT, DUAL_FUNC_38,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    LGUI(KC_DOT),   KC_LEFT_CTRL,   KC_LEFT_GUI,    KC_LEFT_ALT,    KC_NO,                                                                                                          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    DUAL_FUNC_31,   DUAL_FUNC_32,   DUAL_FUNC_39,   KC_TRANSPARENT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_NO,          TD(DANCE_15),   LALT(KC_LEFT_SHIFT),TD(DANCE_16),   LGUI(LCTL(KC_F)),KC_NO,                                                                          LCTL(KC_LEFT),  KC_NO,          LCTL(KC_UP),    LCTL(KC_RIGHT), KC_NO,          KC_NO,
    KC_NO,          KC_NO,          KC_NO,          LALT(LCTL(KC_C)),KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                                                                                          TD(DANCE_17),   KC_NO,          LALT(LCTL(KC_ENTER)),TD(DANCE_18),   KC_NO,
                                                                                                    KC_NO,          KC_NO,          DUAL_FUNC_39,   KC_TRANSPARENT,
                                                                                                                    KC_NO,          LALT(LCTL(KC_EQUAL)),
                                                                                    KC_NO,          KC_TRANSPARENT, KC_NO,          LALT(LCTL(KC_MINUS)),LALT(LCTL(KC_ENTER)),KC_NO
  ),
  [3] = LAYOUT_ergodox_pretty(
    DUAL_FUNC_40,   ST_MACRO_0,     ST_MACRO_1,     ST_MACRO_2,     ST_MACRO_3,     ST_MACRO_4,     DUAL_FUNC_13,                                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_19),
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_41,   KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_43,   KC_TRANSPARENT,
    CW_TOGG,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_42,   KC_TRANSPARENT,                                                                 KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DM_REC1,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_39,   KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [4] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_NO,          KC_MS_UP,       KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,                                 DUAL_FUNC_44,   KC_NO,          KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_KP_PLUS,     KC_NO,
    KC_NO,          KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_NO,          KC_NO,                                                                          KC_NO,          KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_PLUS,     KC_NO,
    KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_MS_BTN2,                                     DUAL_FUNC_45,   KC_NO,          KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_ENTER,    KC_TRANSPARENT,
    KC_NO,          KC_NO,          KC_TRANSPARENT, KC_NO,          KC_MS_BTN1,                                                                                                     KC_KP_0,        KC_KP_0,        KC_KP_DOT,      KC_KP_ENTER,    KC_TRANSPARENT,
                                                                                                    KC_MS_BTN3,     KC_NO,          DUAL_FUNC_39,   KC_TRANSPARENT,
                                                                                                                    KC_MS_WH_UP,    KC_NO,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_WH_DOWN,  KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [5] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TD(DANCE_20),                                   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_21,   KC_TRANSPARENT, DUAL_FUNC_22,   TD(DANCE_21),   DUAL_FUNC_3,                                    KC_TRANSPARENT, DUAL_FUNC_46,   DUAL_FUNC_33,   DUAL_FUNC_34,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_LEFT_CTRL,   DUAL_FUNC_23,   DUAL_FUNC_24,   KC_TRANSPARENT, DUAL_FUNC_25,   KC_TRANSPARENT,                                                                 DUAL_FUNC_35,   KC_TRANSPARENT, DUAL_FUNC_36,   DUAL_FUNC_37,   KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, DUAL_FUNC_26,   DUAL_FUNC_27,   DUAL_FUNC_28,   DUAL_FUNC_29,   DUAL_FUNC_30,   KC_TRANSPARENT,                                 KC_TRANSPARENT, DUAL_FUNC_38,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [6] = LAYOUT_ergodox_pretty(
    ...
    KC_B,           KC_NO,          KC_TRANSPARENT, KC_E,           KC_G,                                                                                                           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_GUI,
                                                                                                    KC_M,           KC_7,           DUAL_FUNC_39,   KC_LEFT_GUI,
                                                                                                                    KC_7,           KC_TRANSPARENT,
  ...
  [7] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,                                                                                                          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_GUI,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_39,   KC_LEFT_GUI,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [8] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,                                                                                                          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_GUI,
                                                                                                    KC_M,           KC_TRANSPARENT, DUAL_FUNC_39,   KC_LEFT_GUI,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
